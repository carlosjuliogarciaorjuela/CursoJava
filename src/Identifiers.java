 ...
 * Los nombres deben comenzar con una letra Los nombres deben comenzar con
 * una letra minúscula y no pueden contener espacios en blanco. Los nombres
 * también pueden comenzar con $ y _
 * Los nombres distinguen entre mayúsculas y minúsculas ("myVar" y "myvar" son
 * variables diferentes)
 * Las palabras reservadas (como las palabras clave de Java, como into boolean)
